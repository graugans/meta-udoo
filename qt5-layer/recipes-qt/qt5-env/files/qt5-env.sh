...
# Physical screen width and height in millimeters. On platforms where
# the framebuffer device /dev/fb0 is not available or the query is not
# successful, the values are calculated based on a default DPI of 100.
# This variable can be used to override any such defaults.
#
